...
class Proxytap < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/kyungw00k/proxytap/releases/download/v0.1.1/proxytapd-darwin-amd64"
    ...
    on_arm do
      url "https://github.com/kyungw00k/proxytap/releases/download/v0.1.1/proxytapd-darwin-arm64"
  ...
  on_linux do
    on_intel do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/kyungw00k/proxytap/releases/download/v0.1.1/proxytapd-linux-amd64"
    ...
    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/kyungw00k/proxytap/releases/download/v0.1.1/proxytapd-linux-arm64"
